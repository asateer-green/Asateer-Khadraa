...
export const MediaServicePage: React.FC = () => {
  const { t, language } = useLanguageContext();

  const isRtl = language === "ar";
  const ArrowIcon = isRtl ? ArrowLeft : ArrowRight;

  // جلب النقاط الفرعية الخاصة بقسم التصميم والميديا
  const bullets: string[] = [
    t("services.items.media.bullets.0"),
    t("services.items.media.bullets.1"),
    t("services.items.media.bullets.2"),
    t("services.items.media.bullets.3"),
  ];
...
export default MediaServicePage;
// src/features/dashboard/portfolio-manager/PortfolioPreviewModal.tsx
import { useState } from "react";
import { X, ChevronLeft, ChevronRight, Calendar, User, Layers } from "lucide-react";
...
export function PortfolioPreviewModal({ item, ar, onClose }: { item: PortfolioPreview; ar: boolean; onClose: () => void }) {
  // السلايدر بقى state داخلي للمكوّن بدل ما يتسرّب لأعلى المكوّن الرئيسي (PortfolioManager)
      ...
      >
        ...
        <div className="md:col-span-5 p-6 md:p-8 flex flex-col justify-between overflow-y-auto max-h-[40vh] md:max-h-full border-t md:border-t-0 md:border-s border-zinc-800 bg-zinc-900/60">
          <div className="text-start">
            <span className="text-xs font-bold text-emerald-400 uppercase tracking-widest block mb-2">{item.category}</span>
